...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, sep=";", error_bad_lines=False, low_memory=False, encoding='latin-1')
            books = pd.read_csv(self.data_validation_config.books_csv_file, sep=";", error_bad_lines=False, low_memory=False, encoding='latin-1')
            
            logging.info(f" Shape of ratings data file: {ratings.shape}")
            logging.info(f" Shape of books data file: {books.shape}")

            #Here Image URL columns is important for the poster.
            ...
            # cleaned data for transformation
            ...
            # final_rating objects for web app(final data save as a pickle file)
